...
banner:
  ...
  btns: 
    ...
    - { name: 'Github >', href: 'https://github.com/leewr/ui' }
  caption: '当前版本: v0.0.1'
features: 
...
footer:
  copyRight:
    name: 'YMFE Team'
    href: 'https://www.touna.cn/'
  links:
    团队网址:
      - { name: 'TNFE', href: 'https://www.touna.cn/' }
      - { name: 'YMFE Blog', href: 'https://www.touna.org/' }
    Git仓库:
      - { name: 'Github', href: 'https://github.com/leewr/ui' }
      - { name: 'Github Issue', href: 'https://github.com/leewr/ui/issues' }
